...
import ra.session11.repository.ProductRepository;
import ra.session11.util.ProductMapper;
...
public class ProductService {
    ...
    public ResponseEntity<DataResponse<?>> addProduct(ProductRequest request, BindingResult bindingResult) {
    ...
    public ResponseEntity<DataResponse<?>> updateProduct(ProductRequest request, long id) {
    ...
    public ResponseEntity<DataResponse<Page<Product>>> findAllAndSearch(Pageable pageable , String searchName) {
        ...
        Page<Product> page = productRepository.findByProductNameContaining(searchName, pageable);
    ...
    public ResponseEntity<DataResponse<List<Product>>> getProductSuggestions() {
        ...
        List<Product> products = productRepository.findTop10ByProductNameContaining(lastSearchLog, PageRequest.of(0, 10)).getContent();
